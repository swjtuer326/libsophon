...
int main(int argc, char *args[]) {
    ...
    const char* oip = "/samples/test_picture/overlay_image.png";
    ...
    const char* base_image_path = "/samples/test_picture/1920_1080_rgb_packed.bin";
    const char* output_image_cpu_path = "/samples/output_picture/multi_overlay_cpu2.bin";
    const char* output_image_tpu_path = "/samples/output_picture/multi_overlay_tpu2.bin";

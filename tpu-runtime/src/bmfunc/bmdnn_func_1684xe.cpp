...
void bmdnn_func_1684xe::fill_api_info(const tpu_net_info_t &net_info,
                                     api_info_t &api_info) {
...
bm_status_t
bmdnn_func_1684xe::_bmdnn_multi_fullnet_(bm_handle_t handle,
...
bm_status_t bmdnn_func_1684xe::_bmdnn_dynamic_fullnet_(
        bm_handle_t handle,
...
bm_status_t  bmdnn_func_1684xe::_bmdnn_set_profile_enable_(bm_handle_t handle, tpu_kernel_function_t func_id, bool enable){
     BMRT_ASSERT_INFO(handle,"handle shouldn't be NULL\n");
...
bm_status_t bmdnn_func_1684xe::_bmdnn_get_profile_data_(
        bm_handle_t handle,
        tpu_kernel_function_t func_id,
